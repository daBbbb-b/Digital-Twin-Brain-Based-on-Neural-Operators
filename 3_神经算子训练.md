...
> We train a neural operator to approximate the inverse mapping from observed brain activity to latent task stimuli, using simulated data generated from stochastic ODE/PDE brain dynamics. The forward physical models are only used for data generation, while the neural operator is exclusively trained for stimulus inference and generalizes to real task-fMRI data.
...
* 把 **成员 A / B / C 的任务接口完全对齐**
* 给成员 C 设计一个 **最小可跑的反演 baseline**
* 或帮你准备 **老师可能会抓的 3 个概念雷区**
